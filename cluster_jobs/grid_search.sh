...
./grid_search.py --resolution=7 --pool-size=35 --trials 1 --skip=70000 --stop-at=80000 experiments/1_class/*.argos experiments/2_class/*.argos experiments/4_class/*.argos build/loop_functions/libsegregation_loop_function.so
